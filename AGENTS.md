...
- Migração `0022_whatsapp.sql` — tabela `whatsapp_channels` (RLS padrão membership;
  ...
  0028 = `ai_agents` (ver seções próprias abaixo); **próxima migração livre: 0029**.
...
**Peças:**
- Agentes reais em `ai_agents` (migração `0028_ai_agents.sql`), aba **Conversation AI** do módulo **Agentes de IA** (`src/components/ai/conversation-ai-tab.tsx`).
