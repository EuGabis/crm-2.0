...
export const triagemFlow: BotFlow = {
  ...
  nodes: {
    ...
    pergunta_objetivo: {
      ...
      listButton: "Responder",
      options: [
        { id: "obj_agora", title: "Agora", description: "Quero começar o quanto antes" },
        { id: "obj_breve", title: "Em breve", description: "Pretendo começar nos próximos meses" },
        { id: "obj_anoquevem", title: "Ano que vem", description: "Estou pesquisando para o próximo ano" },
        { id: "obj_curiosidade", title: "Apenas Curiosidade", description: "Tenho só curiosidade sobre a profissão" },
      ],
    ...
    pergunta_situacao: {
      ...
      listButton: "Responder",
      options: [
        { id: "sit_trabalho", title: "Mudar Trabalho", description: "Quero mudar de trabalho pois não estou feliz com o meu" },
        { id: "sit_financeira", title: "Financeira", description: "Quero melhorar minha situação financeira" },
        { id: "sit_paixao", title: "Paixão pela aviação", description: "Sou apaixonado pela aviação e sempre quis trabalhar nela" },
        { id: "sit_curiosidade", title: "Curiosidade", description: "Quero conhecer o curso por curiosidade" },
      ],
      next: "qualifica",
    },
